            ...
            <tbody>
              {levelConfig.map((level) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-[#4b5563] text-[12px]">
                    {level.perks
                      .slice(0, 2)
                      .join(', ')}{' '}
                  ...
                  <td className="py-3 px-4">
                    <button className="text-[#4b5563] hover:text-[#f5c518] text-[12px] font-medium transition-colors">
                      ✎ Edit
                    </button>
                  </td>
                </tr>
      ...
      <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          {pointsRules.map((rule) => (
            <div
              key={rule.id}
              className="bg-[rgba(255,255,255,0.03)] rounded-xl p-4 border border-[#e5e7eb] flex items-start justify-between"
            >
              <div>
